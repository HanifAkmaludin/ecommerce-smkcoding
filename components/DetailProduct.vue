      ...
      <div class="flex items-center">
        ...
        <div class="w-1/2 pl-5">
          ...
          <div class="flex flex-col gap-4">
            <div class="w-full flex items-center gap-4 bg-blue-600 text-white py-3 justify-center rounded-lg cursor-pointer hover:bg-blue-600/80 transition duration-300 relative" @click="props.product.isCart = !props.product.isCart">
              <i class="ri-shopping-cart-2-line"></i>
              <span v-if="!props.product.isCart">Add to Cart</span>
